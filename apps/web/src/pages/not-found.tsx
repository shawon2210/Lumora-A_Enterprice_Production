...
export default function NotFoundPage() {
  ...
  return (
    <>
      <SEO title="404 — Page Not Found | Lumora" />
      <div className="bg-surface-primary flex min-h-screen flex-col items-center justify-center px-4">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(12,142,233,0.06),transparent_60%)]" />
        <motion.div
        ...
        >
          <p className="text-primary-400 mb-4 font-mono text-sm font-medium uppercase tracking-widest">404</p>
          <h1
