...
import { loginSchema, type LoginInput } from '@lumora/validators';
      ...
      >
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-neutral-950 px-2 text-white/40">or continue with email</span>
          </div>
        </div>
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center gap-2 text-sm text-white/60">
              <input
                ...
                className="text-primary-500 rounded border-white/20 bg-white/5"
              />
              Remember me
            </label>
            <Link
